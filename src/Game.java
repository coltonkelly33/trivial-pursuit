...
public class Game {
	...
	// 
	// Agreed. The original method I had was almost line-for-line the same as this :)
	// But then I started worrying about rand spitting out duplicates. That actually
	// doesn't matter since we're just swapping based on i. 
